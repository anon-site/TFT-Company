...
const TFT_TRANSLATIONS = {
  en: {
    ...
    "ops.eyebrow":"Where We Operate","ops.title":"Across Greece. Countless Streets.","ops.desc":"From the bustling boulevards of Athens to the sun-lit Greek islands — we deliver where it matters most.",
    "ops.gr.name":"Greece","ops.gr.tag":"Mainland & islands coverage",
    "ops.f1.t":"Wide Coverage","ops.f1.d":"25+ cities across Greece.",
    ...
    "hero.badge":"Trusted Across Greece","hero.title":"TFT Company","hero.subtitle":"Where Prompt Delivery Meets Today's Need",
    "hero.desc":"Delivering Excellence. Apply now for a delivery role and join our dedicated team serving communities across Greece.",
    "hero.btnJoin":"Join Our Team","hero.btnServices":"Our Services",
    "about.eyebrow":"Get to Know Us","about.title":"Delivering Excellence Across Greece",
    ...
    "about.p2":"Our delivery company, operating successfully in Greece for the past two years, boasts a versatile fleet comprising motorcycles, electric bikes, and vans. We specialize in providing top-notch delivery services across the region, ensuring swift and reliable solutions for all your logistical needs.",
    "about.stat1":"Years Active","about.stat2":"Deliveries","about.stat3":"Country",
    ...
    "gallery.o1":"On the Move","gallery.o1.desc":"We work around the clock for you, without breaks","gallery.o2":"Ready to Ride","gallery.o2.desc":"Ready to start with you at all times","gallery.o3":"Door to Door","gallery.o3.desc":"Our orders go from the store door to the customer door","gallery.o4":"Fast Service","gallery.o4.desc":"We deliver orders on time without delay","gallery.o5":"Our Team","gallery.o5.desc":"Our team has a beautiful spirit and cooperation is our foundation","gallery.o6":"Riders First","gallery.o6.desc":"Our company's priority is the driver first",
    ...
    "team.f1":"Experienced & trained riders","team.f2":"Versatile fleet — bikes, e-bikes & vans","team.f3":"Customer-first mindset","team.f4":"Active across Greece",
    ...
    "contact.eyebrow":"Join Our Team","contact.title":"Apply Now & Ride With Us","contact.desc":"Apply now for a delivery role and join our dedicated team serving communities across Greece.",
    "contact.available":"Available Now","contact.infoTitle":"Get in Touch","contact.infoDesc":"Delivering Excellence. Get in touch today and let us handle your delivery needs across Greece.",
  ...
  el: {
    ...
    "ops.eyebrow":"Πού Δραστηριοποιούμαστε","ops.title":"Σε όλη την Ελλάδα. Αμέτρητοι Δρόμοι.","ops.desc":"Από τους ζωντανούς δρόμους της Αθήνας μέχρι τα ηλιόλουστα ελληνικά νησιά — παραδίδουμε εκεί που έχει σημασία.",
    "ops.gr.name":"Ελλάδα","ops.gr.tag":"Κάλυψη ηπειρωτικής και νησιών",
    "ops.f1.t":"Ευρεία Κάλυψη","ops.f1.d":"25+ πόλεις σε όλη την Ελλάδα.",
    ...
    "hero.badge":"Αξιόπιστοι σε Ελλάδα","hero.title":"TFT Company","hero.subtitle":"Όπου η ταχεία παράδοση συναντά τις σύγχρονες ανάγκες",
    "hero.desc":"Παρέχουμε αριστεία. Κάνε αίτηση για θέση οδηγού και γίνε μέλος της αφοσιωμένης ομάδας μας σε Ελλάδα.",
    "hero.btnJoin":"Γίνε μέλος","hero.btnServices":"Οι Υπηρεσίες μας",
    "about.eyebrow":"Γνωρίστε μας","about.title":"Αριστεία στις Παραδόσεις σε Ελλάδα",
    "about.p1":"Καλώς ήρθατε στον ψηφιακό μας χώρο! Είμαστε εδώ για να εμπνεύσουμε, να ενημερώσουμε και να βοηθήσουμε.",
    "about.p2":"Η εταιρεία μας δραστηριοποιείται με επιτυχία σε Ελλάδα τα τελευταία δύο χρόνια, με στόλο μοτοσικλετών, ηλεκτρικών ποδηλάτων και φορτηγών. Προσφέρουμε γρήγορες και αξιόπιστες λύσεις για κάθε εφοδιαστική ανάγκη.",
    "about.stat1":"Χρόνια δράσης","about.stat2":"Παραδόσεις","about.stat3":"Χώρα",
    ...
    "gallery.o1":"Σε κίνηση","gallery.o1.desc":"Εργαζόμαστε όλο το 24ωρο για εσάς, χωρίς διακοπές","gallery.o2":"Έτοιμοι","gallery.o2.desc":"Έτοιμοι να ξεκινήσουμε μαζί σας σε όλες τις ώρες","gallery.o3":"Από πόρτα σε πόρτα","gallery.o3.desc":"Οι παραγγελίες μας πηγαίνουν από την πόρτα του καταστήματος στην πόρτα του πελάτη","gallery.o4":"Γρήγορη εξυπηρέτηση","gallery.o4.desc":"Παραδίδουμε τις παραγγελίες στην ώρα τους χωρίς καθυστέρηση","gallery.o5":"Η ομάδα μας","gallery.o5.desc":"Η ομάδα μας έχει όμορφο πνεύμα και η συνεργασία είναι η βάση μας","gallery.o6":"Οδηγοί πρώτα","gallery.o6.desc":"Η προτεραιότητα της εταιρείας μας είναι ο οδηγός πρώτα",
    ...
    "team.f1":"Έμπειροι & εκπαιδευμένοι οδηγοί","team.f2":"Ευέλικτος στόλος — μηχανές, e-bikes & βαν","team.f3":"Πελατοκεντρική νοοτροπία","team.f4":"Ενεργοί σε Ελλάδα",
    ...
    "contact.eyebrow":"Γίνε μέλος","contact.title":"Κάνε Αίτηση & Ακολούθησέ μας","contact.desc":"Κάνε αίτηση για θέση οδηγού και γίνε μέλος της ομάδας μας σε Ελλάδα.",
  ...
  ar: {
    ...
    "ops.eyebrow":"أين نعمل","ops.title":"في كل أنحاء اليونان. شوارع لا تعد ولا تحصى.","ops.desc":"من شوارع أثينا النابضة إلى الجزر اليونانية المشمسة — نوصل حيث يهم الأمر.",
    "ops.gr.name":"اليونان","ops.gr.tag":"تغطية البر الرئيسي والجزر",
    "ops.f1.t":"تغطية واسعة","ops.f1.d":"أكثر من 25 مدينة في جميع أنحاء اليونان.",
    ...
    "hero.badge":"موثوقون في اليونان","hero.title":"شركة TFT","hero.subtitle":"حيث يلتقي التوصيل السريع باحتياجات اليوم",
    "hero.desc":"نقدم التميز. قدّم الآن للحصول على وظيفة توصيل وانضم إلى فريقنا المتفاني الذي يخدم المجتمعات في اليونان.",
    "hero.btnJoin":"انضم إلى فريقنا","hero.btnServices":"خدماتنا",
    "about.eyebrow":"تعرّف علينا","about.title":"التميز في التوصيل عبر اليونان",
    "about.p1":"مرحباً بك في عالمنا الرقمي! نحن هنا لنُلهمك ونُعلمك ونساعدك. استكشف وتعلّم ودع فضولك يزدهر.",
    "about.p2":"تعمل شركتنا بنجاح في اليونان منذ عامين، بأسطول متنوع من الدراجات النارية والدراجات الكهربائية والشاحنات الصغيرة. نتخصص في تقديم خدمات توصيل متميزة وحلول سريعة وموثوقة لجميع احتياجاتك اللوجستية.",
    ...
    "gallery.o1":"في الطريق","gallery.o1.desc":"نعمل طوال الأيام لأجلكم دون استراحة","gallery.o2":"جاهزون للانطلاق","gallery.o2.desc":"جاهزون للإنطلاق معكم في كل الأوقات","gallery.o3":"من الباب الى الباب","gallery.o3.desc":"شعار الطلبية لدينا من باب المتجر الى باب العميل","gallery.o4":"خدمة سريعة","gallery.o4.desc":"نسلم الطلبية في الوقت المناسب دون تأخير","gallery.o5":"فريقنا","gallery.o5.desc":"فريقنا يتمتع بروح جميلة والتعاون هو أساسنا","gallery.o6":"السائقون أولاً","gallery.o6.desc":"أولوية شركتنا في السائق أولا",
    ...
    "team.f1":"سائقون مدربون وذوو خبرة","team.f2":"أسطول متنوع — دراجات، دراجات كهربائية وشاحنات","team.f3":"عقلية تضع العميل أولاً","team.f4":"نشطون في اليونان",
    ...
    "contact.eyebrow":"انضم إلى فريقنا","contact.title":"قدّم الآن وانطلق معنا","contact.desc":"قدّم الآن للحصول على وظيفة توصيل وانضم إلى فريقنا في اليونان.",
  ...
  fa: {
    ...
    "ops.eyebrow":"جایی که فعالیت می‌کنیم","ops.title":"در سراسر یونان. خیابان‌های بی‌شمار.","ops.desc":"از خیابان‌های پررفت‌و‌آمد آتن تا جزایر آفتابی یونان — هر جا که مهم باشد تحویل می‌دهیم.",
    "ops.gr.name":"یونان","ops.gr.tag":"پوشش خاک اصلی و جزایر",
    "ops.f1.t":"پوشش گسترده","ops.f1.d":"بیش از ۲۵ شهر در سراسر یونان.",
    ...
    "hero.badge":"مورد اعتماد در یونان","hero.title":"شرکت TFT","hero.subtitle":"جایی که تحویل سریع با نیاز امروز ملاقات می‌کند",
    "hero.desc":"ارائه‌دهنده تعالی. همین حالا برای موقعیت پیک درخواست دهید و به تیم متعهد ما در یونان بپیوندید.",
    "hero.btnJoin":"به تیم ما بپیوندید","hero.btnServices":"خدمات ما",
    "about.eyebrow":"با ما آشنا شوید","about.title":"ارائه تعالی در سراسر یونان",
    "about.p1":"به دنیای دیجیتال ما خوش آمدید! ما اینجا هستیم تا الهام‌بخش، آگاه‌کننده و یاری‌دهنده باشیم.",
    "about.p2":"شرکت ما طی دو سال گذشته با موفقیت در یونان فعالیت می‌کند و از ناوگانی متنوع شامل موتورسیکلت، دوچرخه برقی و وانت برخوردار است.",
    ...
    "gallery.o1":"در حرکت","gallery.o1.desc":"ما تمام روز برای شما کار می‌کنیم، بدون استراحت","gallery.o2":"آماده حرکت","gallery.o2.desc":"آماده شروع با شما در تمام زمان‌ها","gallery.o3":"از درب تا درب","gallery.o3.desc":"شعار سفارش ما از درب فروشگاه تا درب مشتری","gallery.o4":"سرویس سریع","gallery.o4.desc":"سفارش را به موقع و بدون تاخیر تحویل می‌دهیم","gallery.o5":"تیم ما","gallery.o5.desc":"تیم ما روح زیبایی دارد و همکاری اساس ماست","gallery.o6":"اول پیک‌ها","gallery.o6.desc":"اولویت شرکت ما راننده اول است",
    ...
    "team.f1":"پیک‌های مجرب و آموزش‌دیده","team.f2":"ناوگان متنوع — موتور، دوچرخه برقی و وانت","team.f3":"رویکرد مشتری‌محور","team.f4":"فعال در یونان",
  ...
  ur: {
    ...
    "ops.eyebrow":"ہم کہاں کام کرتے ہیں","ops.title":"پورے یونان میں۔ بے شمار گلیاں۔","ops.desc":"ایتھنز کی مصروف سڑکوں سے لے کر یونان کے دھوپ بھرے جزائر تک — جہاں ضرورت ہو ہم دیلیوری کرتے ہیں۔",
    "ops.gr.name":"یونان","ops.gr.tag":"مرکزی علاقے اور جزائر کی کوریج",
    "ops.f1.t":"وسیع کوریج","ops.f1.d":"پورے یونان میں 25+ شہر۔",
    ...
    "hero.badge":"یونان میں قابل اعتماد","hero.title":"TFT کمپنی","hero.subtitle":"جہاں فوری ڈلیوری آج کی ضرورت سے ملتی ہے",
    "hero.desc":"عمدگی کی فراہمی۔ ابھی ڈلیوری کے کردار کے لیے درخواست دیں اور یونان میں ہماری وقف ٹیم میں شامل ہوں۔",
    "hero.btnJoin":"ہماری ٹیم میں شامل ہوں","hero.btnServices":"ہماری خدمات",
    "about.eyebrow":"ہمیں جانیں","about.title":"یونان میں عمدہ ڈلیوری",
    "about.p1":"ہمارے ڈیجیٹل دائرے میں خوش آمدید! ہم یہاں آپ کو متاثر، مطلع اور مدد کرنے کے لیے ہیں۔",
    "about.p2":"ہماری ڈلیوری کمپنی پچھلے دو سال سے یونان میں کامیابی سے کام کر رہی ہے، جس میں موٹر سائیکلیں، الیکٹرک بائیکس اور وینز شامل ہیں۔",
    ...
    "gallery.o1":"حرکت میں","gallery.o1.desc":"ہم آپ کے لیے دن رات کام کرتے ہیں، بغیر کسی وقفہ کے","gallery.o2":"تیار","gallery.o2.desc":"آپ کے ساتھ ہر وقت شروع کرنے کے لیے تیار","gallery.o3":"دروازے سے دروازے تک","gallery.o3.desc":"ہماری آرڈر کا شعار دکان کے دروازے سے گاہک کے دروازے تک","gallery.o4":"تیز سروس","gallery.o4.desc":"ہم آرڈر کو بوقت اور بغیر تاخیر پہنچاتے ہیں","gallery.o5":"ہماری ٹیم","gallery.o5.desc":"ہماری ٹیم کی روح خوبصورت ہے اور تعاون ہماری بنیاد ہے","gallery.o6":"رائیڈرز پہلے","gallery.o6.desc":"ہماری کمپنی کی اولیت رائیڈر پہلے ہے",
    ...
    "team.f1":"تجربہ کار اور تربیت یافتہ رائیڈرز","team.f2":"متنوع بیڑا — بائیکس، ای-بائیکس اور وینز","team.f3":"کسٹمر فرسٹ سوچ","team.f4":"یونان میں سرگرم",
  ...
  es: {
    ...
    "ops.eyebrow":"Dónde Operamos","ops.title":"Por toda Grecia. Calles Sin Fin.","ops.desc":"Desde las animadas avenidas de Atenas hasta las soleadas islas griegas — entregamos donde más importa.",
    "ops.gr.name":"Grecia","ops.gr.tag":"Cobertura continental e insular",
    "ops.f1.t":"Amplia Cobertura","ops.f1.d":"Más de 25 ciudades por toda Grecia.",
    ...
    "hero.badge":"De confianza en Grecia","hero.title":"TFT Company","hero.subtitle":"Donde la entrega rápida se encuentra con la necesidad de hoy",
    "hero.desc":"Entregando excelencia. Solicita ahora un puesto de repartidor y únete a nuestro equipo dedicado en Grecia.",
    "hero.btnJoin":"Únete a Nuestro Equipo","hero.btnServices":"Nuestros Servicios",
    "about.eyebrow":"Conócenos","about.title":"Entregando excelencia en Grecia",
    "about.p1":"¡Bienvenido a nuestro mundo digital! Estamos aquí para inspirar, informar y ayudarte.",
    "about.p2":"Nuestra empresa de entregas opera con éxito en Grecia desde hace dos años, con una flota versátil de motocicletas, bicicletas eléctricas y furgonetas.",
    ...
    "gallery.o1":"En Movimiento","gallery.o1.desc":"Trabajamos las 24 horas para ustedes, sin descansos","gallery.o2":"Listos","gallery.o2.desc":"Listos para empezar con ustedes en todo momento","gallery.o3":"Puerta a Puerta","gallery.o3.desc":"Nuestros pedidos van desde la puerta de la tienda hasta la puerta del cliente","gallery.o4":"Servicio Rápido","gallery.o4.desc":"Entregamos los pedidos a tiempo sin retraso","gallery.o5":"Nuestro Equipo","gallery.o5.desc":"Nuestro equipo tiene un espíritu hermoso y la cooperación es nuestra base","gallery.o6":"Repartidores Primero","gallery.o6.desc":"La prioridad de nuestra empresa es el repartidor primero",
    ...
    "team.f1":"Repartidores experimentados y formados","team.f2":"Flota versátil — motos, e-bikes y furgonetas","team.f3":"Mentalidad centrada en el cliente","team.f4":"Activos en Grecia",
    ...
    "contact.eyebrow":"Únete a Nuestro Equipo","contact.title":"Solicita ahora y conduce con nosotros","contact.desc":"Solicita ahora un puesto de repartidor y únete a nuestro equipo en Grecia.",
  ...
  fr: {
    ...
    "ops.eyebrow":"Où Nous Opérons","ops.title":"Partout en Grèce. D'innombrables Rues.","ops.desc":"Des boulevards animés d'Athènes aux îles grecques ensoleillées — nous livrons là où ça compte.",
    "ops.gr.name":"Grèce","ops.gr.tag":"Couverture du continent et des îles",
    "ops.f1.t":"Large Couverture","ops.f1.d":"Plus de 25 villes partout en Grèce.",
    ...
    "hero.badge":"De confiance en Grèce","hero.title":"TFT Company","hero.subtitle":"Où la livraison rapide rencontre les besoins d'aujourd'hui",
    "hero.desc":"L'excellence livrée. Postulez dès maintenant pour un poste de livreur et rejoignez notre équipe dévouée en Grèce.",
    "hero.btnJoin":"Rejoignez-nous","hero.btnServices":"Nos Services",
    "about.eyebrow":"Découvrez-nous","about.title":"L'excellence livrée en Grèce",
    "about.p1":"Bienvenue dans notre univers numérique ! Nous sommes là pour vous inspirer, vous informer et vous aider.",
    "about.p2":"Notre société de livraison opère avec succès en Grèce depuis deux ans, avec une flotte variée de motos, vélos électriques et fourgonnettes.",
    ...
    "gallery.o1":"En Mouvement","gallery.o1.desc":"Nous travaillons 24h/24 pour vous, sans pause","gallery.o2":"Prêts à Rouler","gallery.o2.desc":"Prêts à démarrer avec vous à tout moment","gallery.o3":"Porte à Porte","gallery.o3.desc":"Nos commandes vont de la porte du magasin à la porte du client","gallery.o4":"Service Rapide","gallery.o4.desc":"Nous livrons les commandes à temps sans retard","gallery.o5":"Notre Équipe","gallery.o5.desc":"Notre équipe a un bel esprit et la coopération est notre base","gallery.o6":"Livreurs d'Abord","gallery.o6.desc":"La priorité de notre entreprise est le livreur d'abord",
    ...
    "team.f1":"Livreurs expérimentés et formés","team.f2":"Flotte variée — motos, vélos électriques et fourgonnettes","team.f3":"Approche centrée client","team.f4":"Actifs en Grèce",
    ...
    "contact.eyebrow":"Rejoignez-nous","contact.title":"Postulez maintenant et roulez avec nous","contact.desc":"Postulez dès maintenant pour un poste de livreur et rejoignez notre équipe en Grèce.",
  ...
  de: {
    ...
    "ops.eyebrow":"Wo wir tätig sind","ops.title":"Überall in Griechenland. Unzählige Straßen.","ops.desc":"Von den lebhaften Boulevards Athens bis zu den sonnigen griechischen Inseln — wir liefern dort, wo es zählt.",
    "ops.gr.name":"Griechenland","ops.gr.tag":"Festland & Inseln Abdeckung",
    "ops.f1.t":"Breite Abdeckung","ops.f1.d":"Über 25 Städte in ganz Griechenland.",
    ...
    "hero.badge":"Vertrauenswürdig in Griechenland","hero.title":"TFT Company","hero.subtitle":"Wo schnelle Lieferung auf den heutigen Bedarf trifft",
    ...
    "about.eyebrow":"Lerne uns kennen","about.title":"Exzellenz in Griechenland",
    "about.p1":"Willkommen in unserer digitalen Welt! Wir sind hier, um zu inspirieren, zu informieren und zu helfen.",
    "about.p2":"Unser Lieferunternehmen ist seit zwei Jahren erfolgreich in Griechenland tätig, mit einer vielseitigen Flotte aus Motorrädern, E-Bikes und Transportern.",
    ...
    "gallery.o1":"Unterwegs","gallery.o1.desc":"Wir arbeiten rund um die Uhr für Sie, ohne Pausen","gallery.o2":"Startklar","gallery.o2.desc":"Bereit, jederzeit mit Ihnen zu starten","gallery.o3":"Tür zu Tür","gallery.o3.desc":"Unsere Bestellungen gehen von der Ladentür zur Kundentür","gallery.o4":"Schneller Service","gallery.o4.desc":"Wir liefern Bestellungen pünktlich ohne Verzögerung","gallery.o5":"Unser Team","gallery.o5.desc":"Unser Team hat einen schönen Geist und Zusammenarbeit ist unsere Grundlage","gallery.o6":"Fahrer Zuerst","gallery.o6.desc":"Die Priorität unseres Unternehmens ist der Fahrer zuerst",
    ...
    "team.f1":"Erfahrene & geschulte Fahrer","team.f2":"Vielseitige Flotte — Motorräder, E-Bikes & Transporter","team.f3":"Kundenorientiert","team.f4":"Aktiv in Griechenland",
    ...
    "contact.eyebrow":"Werde Teil des Teams","contact.title":"Jetzt bewerben & mit uns fahren","contact.desc":"Bewirb dich jetzt für eine Lieferposition und werde Teil unseres Teams in Griechenland.",
  ...
  it: {
    ...
    "ops.eyebrow":"Dove Operiamo","ops.title":"In tutta la Grecia. Strade Infinite.","ops.desc":"Dai vivaci viali di Atene alle soleggiate isole greche — consegniamo dove conta di più.",
    "ops.gr.name":"Grecia","ops.gr.tag":"Copertura continentale e isole",
    "ops.f1.t":"Ampia Copertura","ops.f1.d":"Oltre 25 città in tutta la Grecia.",
    ...
    "hero.badge":"Affidabili in Grecia","hero.title":"TFT Company","hero.subtitle":"Dove la consegna rapida incontra le esigenze di oggi",
    "hero.desc":"Eccellenza consegnata. Candidati ora per un ruolo di consegna e unisciti al nostro team in Grecia.",
    "hero.btnJoin":"Unisciti al Team","hero.btnServices":"I Nostri Servizi",
    "about.eyebrow":"Conoscici","about.title":"Eccellenza nelle consegne in Grecia",
    "about.p1":"Benvenuto nel nostro mondo digitale! Siamo qui per ispirare, informare e aiutarti.",
    "about.p2":"La nostra azienda di consegne opera con successo in Grecia da due anni, con una flotta versatile di moto, e-bike e furgoni.",
    ...
    "gallery.o1":"In Movimento","gallery.o1.desc":"Lavoriamo 24 ore su 24 per voi, senza pause","gallery.o2":"Pronti a Partire","gallery.o2.desc":"Pronti a partire con voi in ogni momento","gallery.o3":"Strade della Città","gallery.o3.desc":"I nostri ordini vanno dalla porta del negozio alla porta del cliente","gallery.o4":"Servizio Veloce","gallery.o4.desc":"Consegniamo gli ordini in tempo senza ritardo","gallery.o5":"Il Nostro Team","gallery.o5.desc":"Il nostro team ha uno spirito bellissimo e la cooperazione è la nostra base","gallery.o6":"Rider al Primo Posto","gallery.o6.desc":"La priorità della nostra azienda è il rider prima",
    ...
    "team.f1":"Rider esperti e formati","team.f2":"Flotta versatile — moto, e-bike e furgoni","team.f3":"Mentalità orientata al cliente","team.f4":"Attivi in Grecia",
    ...
    "contact.eyebrow":"Unisciti al Team","contact.title":"Candidati ora e guida con noi","contact.desc":"Candidati ora per un ruolo di consegna e unisciti al nostro team in Grecia.",
